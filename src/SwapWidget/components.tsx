...
export const DetailView = ({
  ...
  const displayRate = `1 ${toRealSymbol(tokenIn.symbol)} ≈ ${toPrecision(
    rate,
    2
  )} ${toRealSymbol(tokenOut.symbol)}`;

  const revertDisplayRate = `1 ${toRealSymbol(tokenOut.symbol)} ≈ ${new Big(1)
    .div(rate || '1')
    .toFixed(2)} ${toRealSymbol(tokenIn.symbol)}`;
  ...
  return (
    ...
    >
      <div className="__ref-swap-widget-row-flex-center __ref-swap-widget-swap-detail-view-item">
        ...
        >
          Detail {!showDetail ? <FiChevronDown /> : <FiChevronUp />}
        </div>
      ...
      {!showDetail ? null : (
        <>
          <div className="__ref-swap-widget-row-flex-center __ref-swap-widget-swap-detail-view-item">
            ...
            <div>{toPrecision(minReceived || '0', 2)}</div>
          </div>
...
export const TokenAmount = (props: TokenAmountProps) => {
  ...
  return (
    <>
      <div
        className="__ref-swap-widger-token-amount __ref-swap-widget-row-flex-center"
        style={{
      ...
      >
        ...
        <div className="__ref-swap-widger-token-amount_input">
          <input
            ref={ref}
            max={balance}
            min="0"
...
export const SlippageSelector = ({
  ...
  return (
    <div className="__ref-swap-widget_slippage_selector __ref-swap-widget-col-flex-start">
      <span
        style={{
          color: primary,
          paddingBottom: '14px',
      ...
      >
        ...
        <button
          className="__ref-swap-widget_slippage_selector_button"
          style={{
            color: primary,
            background: buttonBg,
          }}
...
const Token = ({ token, onClick, price, balance, isSticky }: TokenProps) => {
  const theme = useContext(ThemeContext);
  const {
    container,
    buttonBg,
  ...
  return (
    <th
      className="__ref-swap-widget_token-selector-token-list-item"
      style={{
        background: hoverLine ? hover : 'transparent',
      }}
        ...
        <div className="__ref-swap-widget-col-flex-start">
          ...
          >
            ...
            <HiOutlineExternalLink
              ...
              fill={hoverOutLink ? iconHover : iconDefault}
            />
          </span>
      ...
      >
        ...
        {isSticky ? (
          <AiFillPushpin
            ...
            fill={hoverPin ? iconHover : iconDefault}
            style={{
              marginLeft: '2px',
            }}
          />
          ...
          <AiOutlinePushpin
            ...
            onMouseEnter={() => setHoverPin(true)}
            onMouseLeave={() => setHoverPin(false)}
            stroke={hoverPin ? iconHover : iconDefault}
          />
        )}
      </div>
    </th>
...
export const TokenListTable = ({
  ...
  return !tokens || tokens.length == 0 ? null : (
    <table className="__ref-swap-widget_token_list_table">
      <tr>
        <th>
...
export const TokenSelector = ({
  ...
  const storagedStartList = JSON.parse(
    localStorage.getItem(REF_WIDGET_STAR_TOKEN_LIST_KEY) || ''
  );
  ...
  return (
    <div
      className="__ref-swap_widget-token_selector"
      style={{
        position: 'relative',
      }}
    >
      <FiChevronLeft onClick={onClose} />
      <div
      ...
      <div
        className="__ref-swap-widget-select-token_input"
        style={{
            ...
            <StarToken
              ...
              onDelete={token => {
                const newStarList = starList.filter(
                  starToken => starToken !== token.symbol.toLowerCase()
                );
...
export const Slider = ({ showSlip }: { showSlip: boolean }) => {
  return (
    <svg
      width="17"
      height="17"
...
export const Loading = () => {
  return (
    <div className="__ref-swap-widget-loading">
      <svg
        width="38"
        height="38"
        viewBox="0 0 38 38"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {state === 'success' &&
          `Swap ${toPrecision(amountIn, 2)} ${
            tokenIn?.symbol
          } for ${toPrecision(amountOut || '0', 3)} ${tokenOut?.symbol}`}
      </div>

      <button
        className="__ref-swap-widget-notification__button"
        style={{
          background: buttonBg,
          fontWeight: 700,
          color: primary,
